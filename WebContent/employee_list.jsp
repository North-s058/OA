      ...
      <div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-4 text-left">
				<a class="btn btn-info" href="employee_add.html">添加员工</a>
			</div>
	...
	table.bootstrapTable({
		...
		columns:[{
			...
			formatter:function(value,row,index,field){
				let update ='<a  type="button" href="ToUpdateEmpServlet?empId='+ row.empId +'" class="btn btn-info" style="margin-right:30px">修改</a>';
				let dele = '<a onclick="if(confirm(\'确认删除?\')){return true;}else{return false;}" type="button" href="DeleteEmpServlet?deptId='+ row.empId +'" class="btn btn-danger">删除</a>';
				return update+dele;
			}
		}]
	})
