	...
	table.bootstrapTable({
		...
		columns:[{
			...
			formatter:function(value,row,index,field){
				let update ='<a  type="button" href="ToUpdateRoleServlet?roleId='+ row.roleId +'" class="btn btn-info" style="margin-right:30px">修改</a>';
				let dele = '<a onclick="if(confirm(\'确认删除?\')){return true;}else{return false;}" type="button" href="DeleteRoleServlet?roleId='+ row.roleId +'" class="btn btn-danger">删除</a>';
				return update+dele;
			}
		}]
	})
