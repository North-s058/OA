      ...
      <div class="container-fluid">
		...
		<div class="col-lg-12">
			<div class="card">
				...
				<div class="card-body">
					<form class="form-horizontal" action="UpdateClassServlet" method="post">
					  <div class="form-group">
						<label class="col-md-3 control-label" for="example-hf-day">班级名称</label>
						<div class="col-md-7">
						<input type="hidden" value="${clase.classId }" name="classId">
						  <input value="${clase.className}" name="className" class="form-control" type="text" id="example-hf-day" placeholder="班级名称">
						</div>
					  </div>
					  <div class="form-group">
						  ...
						  <div class="col-md-7">
							<select name="subjectId" style="padding: 10px 0;" class="form-control" id="example-manager" size="1">
							  <c:forEach items="${subjectList }" var="subject">
							  	<option <c:if test="${clase.subjectId eq subject.subjectId }">selected</c:if> value="${subject.subjectId }">${subject.subjectName}</option>
							  </c:forEach>
							</select>
						  </div>
					  </div>
					  <div class="form-group">
						...
						<div class="col-md-7">
						  <input value="${clase.createTime }" name="createTime" class="form-control" type="date" id="example-hf-hire">
						</div>
					  </div>
					  <div class="form-group">
						<label class="col-md-3 control-label" for="example-hf-qq">班级周期</label>
						<div class="col-md-7">
						  <input value="${clase.classLife }" name="classLife" class="form-control" type="text" id="example-hf-qq" placeholder="班级周期">
						</div>
					  </div>
					  <div class="form-group">
						<label class="col-md-3 control-label" for="example-hf-qq">班级人数</label>
						<div class="col-md-7">
						  <input value="${clase.classCount }" name="classCount" class="form-control" type="text" id="example-hf-qq" placeholder="班级人数">
						</div>
					  </div>
					  <div class="form-group">
						<label class="col-md-3 control-label" for="example-hf-qq">班级地址</label>
						<div class="col-md-7">
						  <input value="${clase.classAddress}" name="classAddress" class="form-control"  type="text" id="example-hf-qq" placeholder="班级地址">
						</div>
					  </div>
					  <div class="form-group">
