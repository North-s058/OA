					  ...
					  <div class="form-group">
						...
						<div class="col-md-7">
						  <label class="radio-inline" for="example-inline-radio1">
						    <input type="radio" <c:if test="${role.status==1}">checked</c:if> id="example-inline-radio1"  name="status" value="1">
						    有效
						  </label>
						  <label class="radio-inline" for="example-inline-radio2">
						    <input type="radio" <c:if test="${role.status==0}">checked</c:if> id="example-inline-radio2" name="status" value="0">
						    无效
						  </label>
						</div>
					  </div>
