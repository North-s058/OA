      ...
      <div class="container-fluid">
		...
		<div class="row">
			<div class="col-lg-4 text-left">
				<a class="btn btn-info" href="ToAddSubjectServlet">添加学科</a>
			</div>
	...
	table.bootstrapTable({
		...
		columns:[{
			...
			formatter:function(value,row,index,field){
				let update ='<a  type="button" href="ToUpdateDSubjectServlet?subjectId='+ row.subjectId +'" class="btn btn-info" style="margin-right:30px">修改</a>';
				let dele = '<a onclick="if(confirm(\'确认删除?\')){return true;}else{return false;}" type="button" href="DeleteSubjectServlet?subjectId='+ row.subjectId +'" class="btn btn-danger">删除</a>';
				return update+dele;
			}
		}]
	})
