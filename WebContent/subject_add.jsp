      ...
      <div class="container-fluid">
		...
		<div class="col-lg-12">
			<div class="card">
				...
				<div class="card-body">
					<form class="form-horizontal" action="AddSubjectServlet" method="post">
					  <div class="form-group">
						<label class="col-md-3 control-label" for="example-hf-day">学科名称</label>
						<div class="col-md-7">
						  <input name="subjectName" class="form-control" type="text" id="example-hf-day" placeholder="学科名称">
						</div>
					  </div>
					  <div class="form-group">
					  ...
					  <div class="form-group">
						...
						<div class="col-md-7">
						  <input name="subjectLife" class="form-control" type="text" id="example-hf-qq" placeholder="学科周期">
						</div>
					  </div>
					  <div class="form-group">
