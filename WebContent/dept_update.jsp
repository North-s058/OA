      ...
      <div class="container-fluid">
		...
		<div class="col-lg-12">
			<div class="card">
				...
				<div class="card-body">
					<form class="form-horizontal" action="UpdateDeptServlet" method="post">
					  <div class="form-group">
						<label class="col-md-3 control-label" for="example-hf-deptName">部门名称</label>
						<div class="col-md-7">
						  <input class="form-control" name="deptName" value="${dept.deptName }" type="text" id="example-hf-deptName" placeholder="部门名称">
					  ...
					  <div class="form-group">
						...
						<div class="col-md-7">
						  <input class="form-control" name="createTime" value="${dept.createTime }" type="date" id="example-hf-create">
						</div>
					  </div>
					  <div class="form-group">
