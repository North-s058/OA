      ...
      <div class="container-fluid">
		...
		<div class="col-lg-12">
			<div class="card">
				...
				<div class="card-body">
					<form class="form-horizontal" action="UpdateSubjectServlet" method="post">
					  <div class="form-group">
						...
						<input type="hidden" value="${subject.subjectId }" name="subjectId">
						  <input value="${subject.subjectName }" name="subjectName" class="form-control" type="text" id="example-hf-day" >
						</div>
					  </div>
					  <div class="form-group">
						<label class="col-md-3 control-label" for="example-hf-hire">成立日期</label>
						<div class="col-md-7">
						  <input value="${subject.createTime }" name="createTime" class="form-control" type="date" id="example-hf-hire">
						</div>
					  </div>
					  <div class="form-group">
						<label class="col-md-3 control-label" for="example-hf-qq">学科周期</label>
						<div class="col-md-7">
						  <input value="${subject.subjectLife }" name="subjectLife" class="form-control" type="text" id="example-hf-qq" >
						</div>
					  </div>
					  <div class="form-group">
						  <label class="col-md-3 control-label" for="example-manager">学科类型</label>
						  <div class="col-md-7">
							<select name="subjectTypeId" style="padding: 10px 0;" class="form-control" id="example-manager" size="1">
					  ...
					  <div class="form-group">
						<div class="col-md-9 col-md-offset-3">
						  <button class="btn btn-primary" type="submit">修改学科</button>
						</div>
					  </div>
					</form>
				</div>
