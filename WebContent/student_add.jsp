				...
				<div class="card-body">
					<form class="form-horizontal" action="addStudentServlet" method="post">
					  <div class="form-group">
						...
						<div class="col-md-7">
						  <input name="studentName" class="form-control" type="text" id="gn_name" placeholder="学员姓名">
						</div>
					  </div>
					  <div class="form-group">
						  ...
						  <div class="col-md-7">
							<select name="classId" style="padding: 10px 0;" class="form-control" id="gn_class" size="1">
							  <c:forEach items="${claseList}" var="clase">
							  	<option   value="${clase.classId }">${clase.className }</option>
							  </c:forEach>							 
							</select>
						  </div>
					  </div>
					  ...
					  <div class="col-md-7">
						<label class="radio-inline" for="man">
						  <input type="radio"  checked="checked" id="man"  name="gender" value="男">
						  男
						</label>
					  ...
					  <div class="form-group">
						...
						<div class="col-md-7">
						  <input name="idCard"  class="form-control" type="text" id="idcard" placeholder="身份证">
						</div>
					  </div>
					  <div class="form-group">
						<label class="col-md-3 control-label" for="graduate_school">毕业学校</label>
						<div class="col-md-7">
						  <input name="greaduateSchool"  class="form-control" type="text" id="graduate_school" placeholder="毕业学校">
						</div>
					  </div>
					  <div class="form-group">
					  ...
					  <div class="form-group">
						...
						<div class="col-md-7">
						  <input name="admissionTime"  class="form-control" type="date" id="example-hf-hire">
						</div>
					  </div>
					  <div class="form-group">
